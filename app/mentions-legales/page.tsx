        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 space-y-6">
            ...
            <Section title="Éditeur du site">
              <p>
                Le site <strong>CDB Video IA</strong> est édité par :
              </p>
              <ul className="list-disc pl-5">
                <li>Dénomination sociale : <strong>LE CONSULTANT IT</strong></li>
                <li>Forme juridique : EURL (entreprise unipersonnelle à responsabilité limitée)</li>
      ...
      <footer className="relative z-10">
        <div className="mx-auto w-full max-w-6xl px-6 pb-10 text-xs text-black/45">
          <div className="flex flex-col justify-between gap-4 border-t border-black/10 pt-6 sm:flex-row sm:items-center">
            <div>
              © {new Date().getFullYear()} CDB Video IA — Tous droits réservés
            </div>
