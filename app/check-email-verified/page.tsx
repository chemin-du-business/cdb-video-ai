...
export default function CheckEmailVerifiedPage() {
  ...
  useEffect(() => {
    const run = async () => {
      // Le callback /auth/callback a déjà fait verifyOtp + cookies.
      // Ici on ne refait PAS verifyOtp.
        ...
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-6">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="truncate text-[11px] font-medium text-black/50">
                Développé en France 🇫🇷
              </div>
            </div>
          </Link>
